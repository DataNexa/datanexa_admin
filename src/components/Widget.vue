...
import LoadingSimple from './LoadingSimple.vue';
export default defineComponent({
    components:{LoadingSimple},
    props:{
        col:String,
        md:String,
        lg:String,
